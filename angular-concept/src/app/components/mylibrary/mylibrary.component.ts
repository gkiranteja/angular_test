...
import { MYLIBRARY, MYLIBRARYDEL, MY_LIBRARY_NEW } from './../../urls.config';
...
export class MylibraryComponent implements OnInit {
  ...
  getMyLibraryItems() {
    ...
    let items = this.requestService.get(MY_LIBRARY_NEW + UID, options);
    items.subscribe((data) => {
      console.log("Data for MyLibraries:", data);
      this.items = data;
      this.errorMsg = false;
  ...
  confirmed() {
    return confirm('Are you sure you want to remove this report from your library?')
  }
